...
\newcommand{\fixme}[1]{\textcolor{magenta}{#1}}
...
% = = = Name
\newcommand{\walletfile}{\texttt{wallet.dat}\xspace}
\newcommand{\bitcoinclient}{\texttt{Bitcoin Core}\xspace}
\newcommand{\multibit}{\texttt{MultiBit}\xspace}
\newcommand{\armory}{\texttt{Armory}\xspace}
\newcommand{\paper}{\texttt{Bitaddress}\xspace}
\newcommand{\brain}{\texttt{Brainwallet}\xspace}
\newcommand{\block}{\texttt{Blockchain.info}\xspace}
\newcommand{\coinbase}{\texttt{Coinbase.com}\xspace}
