...
\section{Results}
For space reasons, we summarize the results of each task for each client. Detailed walkthroughs can be found in our full technical report.\footnote{\url{http://users.encs.concordia.ca/~clark/papers/2014_usec_full.pdf}}
